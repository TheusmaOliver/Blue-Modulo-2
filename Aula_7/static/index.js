...
// Selecionando o pokémon quando o usuário clicar em um card
    ...
    cardPokemon.addEventListener('click',function(){
        ...
        if(!this.classList.contains('selecionado')){
            ...
            pokemonSelecionado.innerHTML = `
                O último pokemon selecionado foi o <b>${nomePokemon}</b>!
            `
        }else{
            ...
            if(pokemonSelecionados.length>=1){
                pokemonSelecionado.innerHTML = `
                    Você desmarcou o pokémon <b>${nomePokemon}</b>. Restantes:<b> ${pokemonSelecionados.length}</b>
                `
            }else{
